...
CREATE TABLE `devoluciondetalle` (
  ...
  `peticion_id` varchar(15) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `devoluciondetalle_ibfk_1` (`usuario_id`),
  KEY `fk_peticion` (`peticion_id`),
  CONSTRAINT `devoluciondetalle_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `fk_peticion` FOREIGN KEY (`peticion_id`) REFERENCES `peticiones` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-12-04 13:19:01
